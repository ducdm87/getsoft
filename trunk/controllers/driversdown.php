...
class DIRControllerDriversdown extends DIRController
{
	var $return_url='';
	...
	function getCategory()
	{
		...
		@set_time_limit(60 * 5);
			$model->getDriversdown();
		@set_time_limit($defalutExecution);
		echo 'get category for driversdown.com sucessfully';
		die();
	}
	...
	function getData()
	{
		...
		$param['task']		=	'driversdown.getData';		
		$param['live']		=	'1';
...
//		die();
		...
		@set_time_limit(60 * 30);
			...
			if ($page == 0) {
				...
				$fp = fopen( dirname(__FILE__).DS.'..'.DS.'log'.DS.'driversdown_logfile.txt', 'a');
			...
			$query	=	'UPDATE `#__software_category_driversdown` 
...
echo '<hr /><br /> get category for driversdown.com ';
